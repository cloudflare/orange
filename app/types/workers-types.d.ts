// this file is for adding types that are in the latest @cloudflare/workers-types, but we can't upgrade
// yet because @remix-run/cloudflare specifies a peer dependency of 2.0.0 || 3.0.0
